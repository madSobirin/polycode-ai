  ...
  return (
    <header className="flex justify-between items-center w-full px-8 py-4 bg-slate-50 border-b border-slate-100">
      ...
      <div className="flex items-center gap-4">
        <button className="text-slate-500 font-[Manrope] font-bold tracking-tight text-sm hover:text-blue-500 transition-colors flex items-center gap-1.5 cursor-pointer">
